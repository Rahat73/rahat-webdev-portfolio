  ...
  return (
    <>
      <motion.div
        ...
        animate={{ x: "-101vw" }}
        transition={{ delay: 3 }}
        className="fixed top-0 left-0 w-full h-screen bg-fuchsia-950 z-30"
      >
        <motion.div
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-full h-screen bg-fuchsia-900 z-30"
      ></motion.div>
      <motion.div
        initial={{ x: "100vw" }}
        animate={{ x: "-101vw" }}
        transition={{ delay: 2, duration: 2.25, ease: "anticipate" }}
        className="fixed top-0 left-0 w-full h-screen bg-fuchsia-800 z-30"
      ></motion.div>{" "}
    </>
  );
};
